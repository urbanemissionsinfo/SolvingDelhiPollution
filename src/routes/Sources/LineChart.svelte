<script>
  ...
  export let data;
	...
	export let max_transport_drop=40;
  export let max_dust_drop=40;
	export let max_cook_drop=40;
	export let max_heat_drop=50;
	export let max_industries_drop=50;
	export let max_waste_drop=80;
	export let max_stubble_drop=50;
	export let max_other_drop=50;
  ...
  const stubbleshare = 8;
	...
	$: for (var i=1; i<futureyears.length; i++){
		futureyears[i].averagePM25 = futureyears[1].averagePM25 - 
			(transportshare*max_transport_drop/100 +
      dustshare*max_dust_drop/100 +
      cookingshare*max_cook_drop/100 +
      heatshare*max_heat_drop/100 + 
      industriesshare*max_industries_drop/100 + 
      wasteshare*max_waste_drop/100 + 
      stubbleshare*max_stubble_drop/100 +
       remainingshare*max_other_drop/100)*(futureyears[i].drop/100);
	}
