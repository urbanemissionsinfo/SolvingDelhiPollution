import "clsx";
import { w as attr, x as attr_style, y as ensure_array_like, z as bind_props, F as stringify, v as head, G as attr_class } from "../../chunks/index.js";
...
function App($$renderer) {
  ...
  let theme = "default";
  $$renderer.push(`<h1>Emission changes required for Delhi's PM2.5 to reach 40 �g/m3 by 2040</h1> <div${attr_class("svelte-pqt1n5", void 0, { "purple-theme": theme === "purple" })}><label for="basic-range" class="svelte-pqt1n5">Maximum drop in COVID-like emissions by 2040 (%)</label> `);
