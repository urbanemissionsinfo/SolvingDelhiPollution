...
function LineChart($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let max_transport_drop = fallback($$props["max_transport_drop"], 40);
    let max_dust_drop = fallback($$props["max_dust_drop"], 40);
    let max_cook_drop = fallback($$props["max_cook_drop"], 40);
    let max_heat_drop = fallback($$props["max_heat_drop"], 50);
    let max_industries_drop = fallback($$props["max_industries_drop"], 50);
    let max_waste_drop = fallback($$props["max_waste_drop"], 80);
    let max_stubble_drop = fallback($$props["max_stubble_drop"], 50);
    let max_other_drop = fallback($$props["max_other_drop"], 50);
    const transportshare = 21;
    const dustshare = 8;
    const cookingshare = 10;
    const heatshare = 22;
    const industriesshare = 22;
    const wasteshare = 8;
    const stubbleshare = 8;
    const remainingshare = 4;
    ...
    for (var i = 1; i < futureyears2.length; i++) {
      futureyears2[i].averagePM25 = futureyears2[1].averagePM25 - (transportshare * max_transport_drop / 100 + dustshare * max_dust_drop / 100 + cookingshare * max_cook_drop / 100 + heatshare * max_heat_drop / 100 + industriesshare * max_industries_drop / 100 + wasteshare * max_waste_drop / 100 + stubbleshare * max_stubble_drop / 100 + remainingshare * max_other_drop / 100) * (futureyears2[i].drop / 100);
    }
    $$renderer2.push(`<svg width="80%" height="100%"${attr("viewBox", `0 0 ${stringify(
...
function Range($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("1jw2h3i", $$renderer2, ($$renderer3) => {
    ...
    $$renderer2.push(`<div class="range svelte-1jw2h3i"><div class="range__wrapper svelte-1jw2h3i" tabindex="0" role="slider"${attr("aria-valuemin", min)}${attr("aria-valuemax", max)}${attr("aria-valuenow", value)}${attr("id", id)}><div class="range__track svelte-1jw2h3i"><div class="range__track--highlighted svelte-1jw2h3i"></div> <div${attr_class("range__thumb svelte-1jw2h3i", void 0, { "range__thumb--holding": holding })}>`);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="range__tooltip svelte-1jw2h3i">${escape_html(value)}</div>`);
    }
...
function App($$renderer) {
  let max_transport_drop = 40;
  let max_dust_drop = 40;
  let max_cook_drop = 40;
  let max_heat_drop = 50;
  let max_industries_drop = 50;
  let max_waste_drop = 80;
  let max_stubble_drop = 50;
  let max_other_drop = 50;
  let theme = "default";
  $$renderer.push(`<h1>Emission changes required for Delhi's PM2.5 to reach 40 μg/m3 by 2040</h1> <div class="row svelte-1ekjzfk"><div style="width:45%"${attr_class("svelte-1ekjzfk", void 0, { "purple-theme": theme === "purple" })}><label for="basic-range" class="svelte-1ekjzfk">Maximum drop in transport emissions by 2040 (%)</label> `);
  Range($$renderer, { id: "basic-slider", initialValue: max_transport_drop });
  $$renderer.push(`<!----></div> <div style="width: 45%"${attr_class("svelte-1ekjzfk", void 0, { "purple-theme": theme === "purple" })}><label for="basic-range" class="svelte-1ekjzfk">Maximum drop in dust emissions by 2040 (%)</label> `);
  Range($$renderer, { id: "basic-slider", initialValue: max_dust_drop });
  $$renderer.push(`<!----></div></div> <div class="row svelte-1ekjzfk"><div style="width:45%"${attr_class("svelte-1ekjzfk", void 0, { "purple-theme": theme === "purple" })}><label for="basic-range" class="svelte-1ekjzfk">Maximum drop in cooking emissions by 2040 (%)</label> `);
  Range($$renderer, { id: "basic-slider", initialValue: max_cook_drop });
  $$renderer.push(`<!----></div> <div style="width:45%"${attr_class("svelte-1ekjzfk", void 0, { "purple-theme": theme === "purple" })}><label for="basic-range" class="svelte-1ekjzfk">Maximum drop in residential heating emissions by 2040 (%)</label> `);
  Range($$renderer, { id: "basic-slider", initialValue: max_heat_drop });
  $$renderer.push(`<!----></div></div> <div class="row svelte-1ekjzfk"><div style="width:45%"${attr_class("svelte-1ekjzfk", void 0, { "purple-theme": theme === "purple" })}><label for="basic-range" class="svelte-1ekjzfk">Maximum drop in industrial emissions by 2040 (%)</label> `);
  Range($$renderer, { id: "basic-slider", initialValue: max_industries_drop });
  $$renderer.push(`<!----></div> <div style="width:45%"${attr_class("svelte-1ekjzfk", void 0, { "purple-theme": theme === "purple" })}><label for="basic-range" class="svelte-1ekjzfk">Maximum drop in waste emissions by 2040 (%)</label> `);
  Range($$renderer, { id: "basic-slider", initialValue: max_waste_drop });
  $$renderer.push(`<!----></div></div> <div class="row svelte-1ekjzfk"><div style="width:45%"${attr_class("svelte-1ekjzfk", void 0, { "purple-theme": theme === "purple" })}><label for="basic-range" class="svelte-1ekjzfk">Maximum drop in stubble burning emissions by 2040 (%)</label> `);
  Range($$renderer, { id: "basic-slider", initialValue: max_stubble_drop });
  $$renderer.push(`<!----></div> <div style="width:45%"${attr_class("svelte-1ekjzfk", void 0, { "purple-theme": theme === "purple" })}><label for="basic-range" class="svelte-1ekjzfk">Maximum drop in other emissions by 2040 (%)</label> `);
  Range($$renderer, { id: "basic-slider", initialValue: max_other_drop });
  $$renderer.push(`<!----></div></div> <div class="row svelte-1ekjzfk">`);
  LineChart($$renderer, {
    data,
    futureyears,
    max_transport_drop,
  ...
  $$renderer.push(`<!----></div> <div id="footer" class="svelte-1ekjzfk"><p class="svelte-1ekjzfk"><a href="https://urbanemissions.info/" class="svelte-1ekjzfk">© 2025 Urban Emissions Info LLP</a></p> <p class="svelte-1ekjzfk">Say hello! <a href="mailto:saikrishnadammalapati@gmail.com" class="svelte-1ekjzfk"><i class="fa fa-envelope"></i> Email</a> <a href="https://www.linkedin.com/in/sarath-guttikunda-3a01149" class="svelte-1ekjzfk"><img src="https://d-saikrishna.github.io/assets/linkedin.png"/> LinkedIn</a> <a href="https://github.com/urbanemissionsinfo" target="_blank" class="svelte-1ekjzfk"><img src="https://d-saikrishna.github.io/assets/github.png"/> GitHub</a></p></div>`);
}
